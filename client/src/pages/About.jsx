...
const About = () => {
  return (
    <>
      <section className='bg-gray-2 pb-10 dark:bg-dark lg:pb-20 lg:pt-[120px]'>
        <div className='text-2xl text-black bg-gray-100 p-6 rounded-lg shadow-md'>
          Our Crypto Portfolio AI app provides a seamless solution for managing your cryptocurrency investments effortlessly. With real-time
          data you can stay updated on the latest cryptocurrency prices and trends. Whether you're tracking your portfolio's performance,
          exploring top gainers and losers in the market, or customizing your investment strategy, our app offers a user-friendly interface
          designed to meet your needs. Experience flexibility and ease of use as you navigate through our intuitive features, tailored to
          help you make informed decisions about your crypto assets. Join our community of users and embark on your journey towards smarter
          crypto investment management with Crypto Portfolio AI.
        </div>
